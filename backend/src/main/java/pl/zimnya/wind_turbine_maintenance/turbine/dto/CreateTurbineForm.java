...
import static pl.zimnya.wind_turbine_maintenance.common.exception.ErrorMessages.TURBINE_LATITUDE_REQUIRED;
...
import static pl.zimnya.wind_turbine_maintenance.common.exception.ErrorMessages.TURBINE_LONGITUDE_REQUIRED;
...
public record CreateTurbineForm(
        ...
        @NotNull(message = TURBINE_LATITUDE_REQUIRED)
        @Min(value = -90, message = TURBINE_LATITUDE_MIN)
        @Max(value = 90, message = TURBINE_LATITUDE_MAX)
        Double latitude,

        @NotNull(message = TURBINE_LONGITUDE_REQUIRED)
